...
<body>
  <div class="wrap">
    <div class="header_top">
      <div class="logo">
        <a href="index.php"><h1 style="font-size:50px;color:blue;">Amine Shop</h1></a>
      </div>
        <div class="header_top_right">
        <div class="search_box">
            <form action="search.php" method="POST">
              <input type="text" value="Search for Products"  name="product" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search for Products';}"><input type="submit" name="search" value="SEARCH">
            </form>
          </div>
            ...
            <a href="#" title="View my shopping cart" rel="nofollow">
                ...
                <?php 
                                ...
                                if ($getData) {
                                    ...
                                    $qty = Session::get("qty");
                                    echo "DH".number_format($sum).".0"." | Qty: ".$qty;
                                } else {
                                    echo '(Empty)';
                                }
